...
# from views.admin_pannel.handle_callbacks.retreive_user.reschedule_call.reschedule_api import reschedule_router
...
from .selected_call.reschedule_call import reschedule_call_router
from aiogram import Router, F


expand_user_router = Router()
expand_user_router.include_router(delete_call_user_connection_router)
expand_user_router.include_router(reschedule_call_router)
